...
/* -------------------------------------------------------------------------------------------- */
    ...
    int QFrameWrapper::lqtk_destruct(lua_State* L) {
        QFrame* objPtr = (QFrame*)lua_touserdata(L, 1);
    ...
    void QFrameWrapper::lqtk_QWidget_closeEvent(
                   QCloseEvent* arg1) 
    {
    ...
    bool QFrameWrapper::lqtk_QWidget_event(
                   QEvent* arg1) 
    {
    ...
    void QFrameWrapper::lqtk_QWidget_mouseDoubleClickEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QFrameWrapper::lqtk_QWidget_mouseMoveEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QFrameWrapper::lqtk_QWidget_mousePressEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QFrameWrapper::lqtk_QWidget_mouseReleaseEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QFrameWrapper::lqtk_QWidget_paintEvent(
                   QPaintEvent* arg1) 
    {
    ...
    void QFrameWrapper::lqtk_QWidget_resizeEvent(
                   QResizeEvent* arg1) 
    {
...
/* -------------------------------------------------------------------------------------------- */
                   ...
                   QCloseEvent* arg2) 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::closeEvent1_doLua, &args, "QFrame", "closeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::closeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QFrameWrapper::event(
                   QEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QFrame", "event", msg);
                }
            }
        }
        return QFrame::event(
...
/* -------------------------------------------------------------------------------------------- */
    bool QFrameWrapper::hasHeightForWidth() const
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::hasHeightForWidth1_doLua, &args, "QFrame", "hasHeightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    const char* msg = "a boolean value";
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QFrame", "hasHeightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    int QFrameWrapper::heightForWidth(
                   int arg2) const 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::heightForWidth1_doLua, &args, "QFrame", "heightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QFrame", "heightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    void QFrameWrapper::mouseDoubleClickEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseDoubleClickEvent1_doLua, &args, "QFrame", "mouseDoubleClickEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::mouseDoubleClickEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QFrameWrapper::mouseMoveEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseMoveEvent1_doLua, &args, "QFrame", "mouseMoveEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::mouseMoveEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QFrameWrapper::mousePressEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mousePressEvent1_doLua, &args, "QFrame", "mousePressEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::mousePressEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QFrameWrapper::mouseReleaseEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseReleaseEvent1_doLua, &args, "QFrame", "mouseReleaseEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::mouseReleaseEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QFrameWrapper::paintEvent(
                   QPaintEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::paintEvent1_doLua, &args, "QFrame", "paintEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::paintEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QFrameWrapper::resizeEvent(
                   QResizeEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::resizeEvent1_doLua, &args, "QFrame", "resizeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QFrame::resizeEvent(
                    arg2); 
    }
...
static void* castFunction(const ClassInfo* targetClassInfo, void* objectPtr)
{
    if (objectPtr)
    {
        QFrameBinding::QType* ptr = static_cast<QFrameBinding::QType*>(objectPtr);
...
{
    if (objectPtr) {
        QFrame* obj = (QFrame*) objectPtr;
        
        QFrameWrapper* wrapper = dynamic_cast<QFrameWrapper*>(obj);
        if (wrapper) {
...
extern "C" int lqtk_QFrame_constructor(lua_State* L, bool explicitNew)
{
    lqtk_QFrame_new_Args  argValues;
    lqtk_QFrame_new_Args* args = &argValues;
    try {
        int argOffs = 0;
        int nargs = lua_gettop(L) - 1;
        ObjectUdata* udata = ObjectUdata::checkArg(L, 1, ObjectUdata::INITIAL);

        if (udata->classInfo != &QFrameBinding::classInfo)
        {
            return util::argError(L, 1, "initial object of type lqtk.Object<QFrame> expected");
        }
        ...
        if (nargs == 1) { do {
          if (!lua_isnil(L, argOffs+1)) {
            ...
            {
                QFrameWrapper* rslt = 
                    new QFrameWrapper(args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (nargs == 2) { do {
          if (!lua_isnil(L, argOffs+1)) {
            ...
            {
                QFrameWrapper* rslt = 
                    new QFrameWrapper(args->arg_1_1.getValue(), args->arg_2_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (explicitNew) {
            return util::argCountError(L, "QFrame", "new", nargs, "1,2,3");
        } else {
            return util::argCountError(L, "QFrame", nullptr, nargs, "0,1,2");
        }
    }
    catch (...) {
...
extern "C" int lqtk_QFrame_new(lua_State* L)
{
    return lqtk_QFrame_constructor(L, true /*explicitNew*/);
}

/* ============================================================================================ */

ObjectUdata* QFrameBinding::pushObject(lua_State* L, QFrame* objPtr, OwnerType ownerType)
{
    QFrameWrapper* wrapper = dynamic_cast<QFrameWrapper*>(objPtr);
    if (!wrapper) {
        QAbstractScrollArea* ptr1 = dynamic_cast<QAbstractScrollArea*>(objPtr);
        if (ptr1) {
            return QAbstractScrollAreaBinding::pushObject(L, ptr1, ownerType);
        }
        QLabel* ptr2 = dynamic_cast<QLabel*>(objPtr);
        if (ptr2) {
            return QLabelBinding::pushObject(L, ptr2, ownerType);
        }
    }
    ...
    {                                                                    // -> xxx
        ...
        udata = ObjectUdata::pushNew<QFrame>(L, hasUserValue);     // -> uval?, udata
...
const ClassInfo QFrameBinding::classInfo = 
{
    "QFrame",
...
int QFrameBinding::pushBinding(lua_State* L)
{
