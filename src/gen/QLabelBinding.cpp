...
/* -------------------------------------------------------------------------------------------- */
                   ...
                   QEvent* arg2) 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QLabel", "event");
            }
            if (args.wasCalled) {
...
/* -------------------------------------------------------------------------------------------- */
    QVariant QLabelWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QLabel", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QLabel", "inputMethodQuery", msg);
                }
            }
        }
        return QLabel::inputMethodQuery(
                    arg2); 
    }
...
/* -------------------------------------------------------------------------------------------- */
                   ...
                   bool arg2) 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QLabel", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLabel::setVisible(
                    arg2); 
    }
