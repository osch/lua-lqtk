...
/* -------------------------------------------------------------------------------------------- */
    ...
    int QLineEditWrapper::lqtk_destruct(lua_State* L) {
        QLineEdit* objPtr = (QLineEdit*)lua_touserdata(L, 1);
        StateGuard::clearWeakUserValue(L, objPtr);
        StateGuard::clearStrongUserValue(L, objPtr);
        return 0;
    }
    QLineEditWrapper::~QLineEditWrapper() {
        trace::printf("Deleting lqtk::QLineEditWrapper: %p\n", this);
        if (lqtk_stateGuard) {
            lua_State* L = lqtk_stateGuard->getL();
            if (L) {
                QLineEdit* objPtr = this;
                BindingUtil::callLuaDestructor(L, lqtk_destruct, objPtr, "QLineEdit");
            }
            StateGuard::releaseRef(&lqtk_stateGuard, StateGuard::FOR_QT_OBJECT);
        }
    }

    void QLineEditWrapper::lqtk_QWidget_closeEvent(
                   QCloseEvent* arg1) 
    {
    ...
    bool QLineEditWrapper::lqtk_QWidget_event(
                   QEvent* arg1) 
    {
    ...
    void QLineEditWrapper::lqtk_QWidget_mouseDoubleClickEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QLineEditWrapper::lqtk_QWidget_mouseMoveEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QLineEditWrapper::lqtk_QWidget_mousePressEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QLineEditWrapper::lqtk_QWidget_mouseReleaseEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QLineEditWrapper::lqtk_QWidget_paintEvent(
                   QPaintEvent* arg1) 
    {
    ...
    void QLineEditWrapper::lqtk_QWidget_resizeEvent(
                   QResizeEvent* arg1) 
    {
...
/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::closeEvent(
                   QCloseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::closeEvent1_doLua, &args, "QLineEdit", "closeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::closeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QLineEditWrapper::event(
                   QEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QLineEdit", "event");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QLineEdit", "event", msg);
                }
            }
        }
        return QLineEdit::event(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QLineEditWrapper::hasHeightForWidth() const
    {
        lua_State* L = getL();
        if (L) {
            QWidgetWrapper::hasHeightForWidth1CallArgs args(
                    const_cast<QLineEditWrapper*>(this)

            );
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::hasHeightForWidth1_doLua, &args, "QLineEdit", "hasHeightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    const char* msg = "a boolean value";
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QLineEdit", "hasHeightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    int QLineEditWrapper::heightForWidth(
                   int arg2) const 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::heightForWidth1_doLua, &args, "QLineEdit", "heightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QLineEdit", "heightForWidth", msg);
                }
            }
        }
        return QLineEdit::heightForWidth(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    QVariant QLineEditWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QLineEdit", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QLineEdit", "inputMethodQuery", msg);
                }
            }
        }
        return QLineEdit::inputMethodQuery(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::mouseDoubleClickEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseDoubleClickEvent1_doLua, &args, "QLineEdit", "mouseDoubleClickEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::mouseDoubleClickEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::mouseMoveEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseMoveEvent1_doLua, &args, "QLineEdit", "mouseMoveEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::mouseMoveEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::mousePressEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mousePressEvent1_doLua, &args, "QLineEdit", "mousePressEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::mousePressEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::mouseReleaseEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseReleaseEvent1_doLua, &args, "QLineEdit", "mouseReleaseEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::mouseReleaseEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::paintEvent(
                   QPaintEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::paintEvent1_doLua, &args, "QLineEdit", "paintEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::paintEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::resizeEvent(
                   QResizeEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::resizeEvent1_doLua, &args, "QLineEdit", "resizeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::resizeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QLineEditWrapper::setVisible(
                   bool arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QLineEdit", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QLineEdit::setVisible(
                    arg2); 
    }
...
static void* castFunction(const ClassInfo* targetClassInfo, void* objectPtr)
{
    if (objectPtr)
    {
        QLineEditBinding::QType* ptr = static_cast<QLineEditBinding::QType*>(objectPtr);
        if (targetClassInfo == &QLineEditBinding::classInfo) {
            return ptr;
        }
...
{
    if (objectPtr) {
        QLineEdit* ptr = (QLineEdit*) objectPtr;
        delete ptr;
    }
}
...
{
    if (objectPtr) {
        QLineEdit* obj = (QLineEdit*) objectPtr;
        
        QLineEditWrapper* wrapper = dynamic_cast<QLineEditWrapper*>(obj);
        if (wrapper) {
...
struct lqtk_QLineEdit_new_Args
{
    explicit lqtk_QLineEdit_new_Args(bool explicitNew)
...
static int lqtk_QLineEdit_new_doLua(lua_State* L)
{
    lqtk_QLineEdit_new_Args* args = (lqtk_QLineEdit_new_Args*) lua_touserdata(L, 1);
    lua_remove(L, 1);
    ...
    try {
        ...
        if (udata->classInfo != &QLineEditBinding::classInfo)
        {
            return util::argError(L, 1, "initial object of type lqtk.Object<QLineEdit> expected");
        }
        ...
        if (nargs == 0) { do {
            {
                QLineEditWrapper* rslt = 
                    new QLineEditWrapper();
                if (!rslt) {
        ...
        if (nargs == 1) { do {
            ...
            {
                QLineEditWrapper* rslt = 
                    new QLineEditWrapper(args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (nargs == 1) { do {
            ...
            {
                QLineEditWrapper* rslt = 
                    new QLineEditWrapper(args->arg_2_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (nargs == 2) { do {
            ...
            {
                QLineEditWrapper* rslt = 
                    new QLineEditWrapper(args->arg_2_1.getValue(), args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (explicitNew) {
            return util::argCountError(L, "QLineEdit", "new", nargs, "1,2,3");
        } else {
            return util::argCountError(L, "QLineEdit", nullptr, nargs, "0,1,2");
        }
    }
    catch (...) {
...
extern "C" int lqtk_QLineEdit_constructor(lua_State* L, bool explicitNew)
{
    try {
        lqtk_QLineEdit_new_Args args(explicitNew);
        return BindingUtil::callMethodFromLua(L, lqtk_QLineEdit_new_doLua, &args);
    }    
    catch (...) {
        return util::handleException(L);
    }
...
extern "C" int lqtk_QLineEdit_new(lua_State* L)
{
    return lqtk_QLineEdit_constructor(L, true /*explicitNew*/);
}

/* ============================================================================================ */

ObjectUdata* QLineEditBinding::pushObject(lua_State* L, QLineEdit* objPtr, OwnerType ownerType)
{
    QLineEditWrapper* wrapper = dynamic_cast<QLineEditWrapper*>(objPtr);
    ...
    {                                                                    // -> xxx
        ...
        udata = ObjectUdata::pushNew<QLineEdit>(L, hasUserValue);     // -> uval?, udata
...
const ClassInfo QLineEditBinding::classInfo = 
{
    "QLineEdit",
...
int QLineEditBinding::pushBinding(lua_State* L)
{
