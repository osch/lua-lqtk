...
/* -------------------------------------------------------------------------------------------- */
                   ...
                   QEvent* arg2) 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QMainWindow", "event");
            }
            if (args.wasCalled) {
...
/* -------------------------------------------------------------------------------------------- */
    QVariant QMainWindowWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QMainWindow", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMainWindow", "inputMethodQuery", msg);
                }
            }
        }
        return QMainWindow::inputMethodQuery(
                    arg2); 
    }
...
/* -------------------------------------------------------------------------------------------- */
    void QMainWindowWrapper::setVisible(
                   bool arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QMainWindow", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMainWindow::setVisible(
                    arg2); 
    }
