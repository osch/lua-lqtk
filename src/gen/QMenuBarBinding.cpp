...
/* -------------------------------------------------------------------------------------------- */
    ...
    int QMenuBarWrapper::lqtk_destruct(lua_State* L) {
        QMenuBar* objPtr = (QMenuBar*)lua_touserdata(L, 1);
        StateGuard::clearWeakUserValue(L, objPtr);
        StateGuard::clearStrongUserValue(L, objPtr);
        return 0;
    }
    QMenuBarWrapper::~QMenuBarWrapper() {
        trace::printf("Deleting lqtk::QMenuBarWrapper: %p\n", this);
        if (lqtk_stateGuard) {
            lua_State* L = lqtk_stateGuard->getL();
            if (L) {
                QMenuBar* objPtr = this;
                BindingUtil::callLuaDestructor(L, lqtk_destruct, objPtr, "QMenuBar");
            }
            StateGuard::releaseRef(&lqtk_stateGuard, StateGuard::FOR_QT_OBJECT);
        }
    }

    void QMenuBarWrapper::lqtk_QWidget_closeEvent(
                   QCloseEvent* arg1) 
    {
    ...
    bool QMenuBarWrapper::lqtk_QWidget_event(
                   QEvent* arg1) 
    {
    ...
    void QMenuBarWrapper::lqtk_QWidget_mouseDoubleClickEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuBarWrapper::lqtk_QWidget_mouseMoveEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuBarWrapper::lqtk_QWidget_mousePressEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuBarWrapper::lqtk_QWidget_mouseReleaseEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuBarWrapper::lqtk_QWidget_paintEvent(
                   QPaintEvent* arg1) 
    {
    ...
    void QMenuBarWrapper::lqtk_QWidget_resizeEvent(
                   QResizeEvent* arg1) 
    {
...
/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::closeEvent(
                   QCloseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::closeEvent1_doLua, &args, "QMenuBar", "closeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::closeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QMenuBarWrapper::event(
                   QEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QMenuBar", "event");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenuBar", "event", msg);
                }
            }
        }
        return QMenuBar::event(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QMenuBarWrapper::hasHeightForWidth() const
    {
        lua_State* L = getL();
        if (L) {
            QWidgetWrapper::hasHeightForWidth1CallArgs args(
                    const_cast<QMenuBarWrapper*>(this)

            );
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::hasHeightForWidth1_doLua, &args, "QMenuBar", "hasHeightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    const char* msg = "a boolean value";
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenuBar", "hasHeightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    int QMenuBarWrapper::heightForWidth(
                   int arg2) const 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::heightForWidth1_doLua, &args, "QMenuBar", "heightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenuBar", "heightForWidth", msg);
                }
            }
        }
        return QMenuBar::heightForWidth(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    QVariant QMenuBarWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QMenuBar", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenuBar", "inputMethodQuery", msg);
                }
            }
        }
        return QMenuBar::inputMethodQuery(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::mouseDoubleClickEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseDoubleClickEvent1_doLua, &args, "QMenuBar", "mouseDoubleClickEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::mouseDoubleClickEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::mouseMoveEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseMoveEvent1_doLua, &args, "QMenuBar", "mouseMoveEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::mouseMoveEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::mousePressEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mousePressEvent1_doLua, &args, "QMenuBar", "mousePressEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::mousePressEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::mouseReleaseEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseReleaseEvent1_doLua, &args, "QMenuBar", "mouseReleaseEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::mouseReleaseEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::paintEvent(
                   QPaintEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::paintEvent1_doLua, &args, "QMenuBar", "paintEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::paintEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::resizeEvent(
                   QResizeEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::resizeEvent1_doLua, &args, "QMenuBar", "resizeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::resizeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuBarWrapper::setVisible(
                   bool arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QMenuBar", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenuBar::setVisible(
                    arg2); 
    }
...
struct lqtk_QMenuBar_addMenu_Args
{
    FromLua<QMenuBar*> arg_1_1;
    FromLua<QMenu*> arg_2_1;
    FromLua<QString> arg_3_1;
    ToLua<QAction*> rslt_1;
    ToLua<QMenu*> rslt_2;
};

static int lqtk_QMenuBar_addMenu_doLua(lua_State* L)
{
    lqtk_QMenuBar_addMenu_Args* args = (lqtk_QMenuBar_addMenu_Args*) lua_touserdata(L, 1);
    lua_remove(L, 1);
    try {
        int argOffs = 0;
        ...
        if (nargs == 2) { do {
            ...
            {
                args->rslt_1 = 
                    args->arg_1_1.getValue()->QMenuBar::addMenu(args->arg_2_1.getValue());
        ...
        if (nargs == 2) { do {
            ...
            {
                args->rslt_2 = 
                    args->arg_1_1.getValue()->QMenuBar::addMenu(args->arg_3_1.getValue());
        ...
        return util::argCountError(L, "QMenuBar", "addMenu", nargs, "2");
    }
    catch (...) {
...
extern "C" int lqtk_QMenuBar_addMenu(lua_State* L)
{
    try {
        lqtk_QMenuBar_addMenu_Args args;
        return BindingUtil::callMethodFromLua(L, lqtk_QMenuBar_addMenu_doLua, &args);
    }    
    catch (...) {
        return util::handleException(L);
    }
...
static void* castFunction(const ClassInfo* targetClassInfo, void* objectPtr)
{
    if (objectPtr)
    {
        QMenuBarBinding::QType* ptr = static_cast<QMenuBarBinding::QType*>(objectPtr);
        if (targetClassInfo == &QMenuBarBinding::classInfo) {
            return ptr;
        }
...
{
    if (objectPtr) {
        QMenuBar* ptr = (QMenuBar*) objectPtr;
        delete ptr;
    }
}
...
{
    if (objectPtr) {
        QMenuBar* obj = (QMenuBar*) objectPtr;
        
        QMenuBarWrapper* wrapper = dynamic_cast<QMenuBarWrapper*>(obj);
        if (wrapper) {
...
struct lqtk_QMenuBar_new_Args
{
    FromLua<QWidget*> arg_1_1;
    ToLua<QMenuBar*> rslt_1;
};

extern "C" int lqtk_QMenuBar_constructor(lua_State* L, bool explicitNew)
{
    lqtk_QMenuBar_new_Args  argValues;
    lqtk_QMenuBar_new_Args* args = &argValues;
    try {
        int argOffs = 0;
        int nargs = lua_gettop(L) - 1;
        ObjectUdata* udata = ObjectUdata::checkArg(L, 1, ObjectUdata::INITIAL);

        if (udata->classInfo != &QMenuBarBinding::classInfo)
        {
            return util::argError(L, 1, "initial object of type lqtk.Object<QMenuBar> expected");
        }
        ...
        if (nargs == 1) { do {
            ...
            {
                QMenuBarWrapper* rslt = 
                    new QMenuBarWrapper(args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (explicitNew) {
            return util::argCountError(L, "QMenuBar", "new", nargs, "1,2");
        } else {
            return util::argCountError(L, "QMenuBar", nullptr, nargs, "0,1");
        }
    }
    catch (...) {
        return util::handleException(L);
...
extern "C" int lqtk_QMenuBar_new(lua_State* L)
{
    return lqtk_QMenuBar_constructor(L, true /*explicitNew*/);
}

/* ============================================================================================ */

ObjectUdata* QMenuBarBinding::pushObject(lua_State* L, QMenuBar* objPtr, OwnerType ownerType)
{
    QMenuBarWrapper* wrapper = dynamic_cast<QMenuBarWrapper*>(objPtr);
    ...
    {                                                                    // -> xxx
        ...
        udata = ObjectUdata::pushNew<QMenuBar>(L, hasUserValue);     // -> uval?, udata
...
static const Member members[] =
{
    ...
    { "addMenu",               Member::NORMAL_FUNCTION,      (void*) lqtk_QMenuBar_addMenu },
...
const ClassInfo QMenuBarBinding::classInfo = 
{
    "QMenuBar",
...
int QMenuBarBinding::pushBinding(lua_State* L)
{
