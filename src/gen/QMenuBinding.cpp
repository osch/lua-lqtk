...
/* -------------------------------------------------------------------------------------------- */
    ...
    int QMenuWrapper::lqtk_destruct(lua_State* L) {
        QMenu* objPtr = (QMenu*)lua_touserdata(L, 1);
        StateGuard::clearWeakUserValue(L, objPtr);
        StateGuard::clearStrongUserValue(L, objPtr);
        return 0;
    }
    QMenuWrapper::~QMenuWrapper() {
        trace::printf("Deleting lqtk::QMenuWrapper: %p\n", this);
        if (lqtk_stateGuard) {
            lua_State* L = lqtk_stateGuard->getL();
            if (L) {
                QMenu* objPtr = this;
                BindingUtil::callLuaDestructor(L, lqtk_destruct, objPtr, "QMenu");
            }
            StateGuard::releaseRef(&lqtk_stateGuard, StateGuard::FOR_QT_OBJECT);
        }
    }

    void QMenuWrapper::lqtk_QWidget_closeEvent(
                   QCloseEvent* arg1) 
    {
    ...
    bool QMenuWrapper::lqtk_QWidget_event(
                   QEvent* arg1) 
    {
    ...
    void QMenuWrapper::lqtk_QWidget_mouseDoubleClickEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuWrapper::lqtk_QWidget_mouseMoveEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuWrapper::lqtk_QWidget_mousePressEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuWrapper::lqtk_QWidget_mouseReleaseEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QMenuWrapper::lqtk_QWidget_paintEvent(
                   QPaintEvent* arg1) 
    {
    ...
    void QMenuWrapper::lqtk_QWidget_resizeEvent(
                   QResizeEvent* arg1) 
    {
...
/* -------------------------------------------------------------------------------------------- */
                   ...
                   QCloseEvent* arg2) 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::closeEvent1_doLua, &args, "QMenu", "closeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::closeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QMenuWrapper::event(
                   QEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QMenu", "event");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenu", "event", msg);
                }
            }
        }
        return QMenu::event(
...
/* -------------------------------------------------------------------------------------------- */
    bool QMenuWrapper::hasHeightForWidth() const
    {
        lua_State* L = getL();
        if (L) {
            QWidgetWrapper::hasHeightForWidth1CallArgs args(
                    const_cast<QMenuWrapper*>(this)

            );
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::hasHeightForWidth1_doLua, &args, "QMenu", "hasHeightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    const char* msg = "a boolean value";
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenu", "hasHeightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    int QMenuWrapper::heightForWidth(
                   int arg2) const 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::heightForWidth1_doLua, &args, "QMenu", "heightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenu", "heightForWidth", msg);
                }
            }
        }
        return QMenu::heightForWidth(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    QVariant QMenuWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QMenu", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QMenu", "inputMethodQuery", msg);
                }
            }
        }
        return QMenu::inputMethodQuery(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::mouseDoubleClickEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseDoubleClickEvent1_doLua, &args, "QMenu", "mouseDoubleClickEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::mouseDoubleClickEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::mouseMoveEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseMoveEvent1_doLua, &args, "QMenu", "mouseMoveEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::mouseMoveEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::mousePressEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mousePressEvent1_doLua, &args, "QMenu", "mousePressEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::mousePressEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::mouseReleaseEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseReleaseEvent1_doLua, &args, "QMenu", "mouseReleaseEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::mouseReleaseEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::paintEvent(
                   QPaintEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::paintEvent1_doLua, &args, "QMenu", "paintEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::paintEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::resizeEvent(
                   QResizeEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::resizeEvent1_doLua, &args, "QMenu", "resizeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::resizeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QMenuWrapper::setVisible(
                   bool arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QMenu", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QMenu::setVisible(
                    arg2); 
    }
...
struct lqtk_QMenu_addAction_Args
{
    FromLua<QMenu*> arg_1_1;
    FromLua<QString> arg_2_1;
    FromLua<QAction*> arg_3_1;
    ToLua<QAction*> rslt_1;
};

static int lqtk_QMenu_addAction_doLua(lua_State* L)
{
    lqtk_QMenu_addAction_Args* args = (lqtk_QMenu_addAction_Args*) lua_touserdata(L, 1);
    lua_remove(L, 1);
    try {
        int argOffs = 0;
        ...
        if (nargs == 2) { do {
            ...
            {
                args->rslt_1 = 
                    args->arg_1_1.getValue()->QMenu::addAction(args->arg_2_1.getValue());
        ...
        if (nargs == 2) { do {
            ...
            {
                    args->arg_1_1.getValue()->QMenu::addAction(args->arg_3_1.getValue());
                return 0;
            }
        } while (false); }
        if (nargs == 2) {
        ...
        return util::argCountError(L, "QMenu", "addAction", nargs, "2");
    }
    catch (...) {
...
extern "C" int lqtk_QMenu_addAction(lua_State* L)
{
    try {
        lqtk_QMenu_addAction_Args args;
        return BindingUtil::callMethodFromLua(L, lqtk_QMenu_addAction_doLua, &args);
    }    
    catch (...) {
        return util::handleException(L);
    }
...
struct lqtk_QMenu_addMenu_Args
{
    FromLua<QMenu*> arg_1_1;
    FromLua<QMenu*> arg_1_2;
    FromLua<QString> arg_2_1;
    ToLua<QAction*> rslt_1;
    ToLua<QMenu*> rslt_2;
};

static int lqtk_QMenu_addMenu_doLua(lua_State* L)
{
    lqtk_QMenu_addMenu_Args* args = (lqtk_QMenu_addMenu_Args*) lua_touserdata(L, 1);
    lua_remove(L, 1);
    try {
        int argOffs = 0;
        int nargs = lua_gettop(L);
        if (nargs == 2) { do {
            ...
            {
                args->rslt_1 = 
                    args->arg_1_1.getValue()->QMenu::addMenu(args->arg_1_2.getValue());
                args->rslt_1.push(L, NOT_OWNER);
                return 1;
            }
        } while (false); }
        if (nargs == 2) { do {
            ...
            {
                args->rslt_2 = 
                    args->arg_1_1.getValue()->QMenu::addMenu(args->arg_2_1.getValue());
                args->rslt_2.push(L, NOT_OWNER);
                return 1;
            }
        } while (false); }
        if (nargs == 2) {
        ...
        return util::argCountError(L, "QMenu", "addMenu", nargs, "2");
    }
    catch (...) {
        return util::handleException(L);
    }
...
extern "C" int lqtk_QMenu_addMenu(lua_State* L)
{
    try {
        lqtk_QMenu_addMenu_Args args;
        return BindingUtil::callMethodFromLua(L, lqtk_QMenu_addMenu_doLua, &args);
    }    
    catch (...) {
        return util::handleException(L);
    }
...
static void* castFunction(const ClassInfo* targetClassInfo, void* objectPtr)
{
    if (objectPtr)
    {
        QMenuBinding::QType* ptr = static_cast<QMenuBinding::QType*>(objectPtr);
        if (targetClassInfo == &QMenuBinding::classInfo) {
            return ptr;
        }
...
{
    if (objectPtr) {
        QMenu* obj = (QMenu*) objectPtr;
        
        QMenuWrapper* wrapper = dynamic_cast<QMenuWrapper*>(obj);
        if (wrapper) {
...
struct lqtk_QMenu_new_Args
{
    explicit lqtk_QMenu_new_Args(bool explicitNew)
...
static int lqtk_QMenu_new_doLua(lua_State* L)
{
    lqtk_QMenu_new_Args* args = (lqtk_QMenu_new_Args*) lua_touserdata(L, 1);
    lua_remove(L, 1);
    ...
    try {
        ...
        if (udata->classInfo != &QMenuBinding::classInfo)
        {
            return util::argError(L, 1, "initial object of type lqtk.Object<QMenu> expected");
        }
        ...
        if (nargs == 1) { do {
            ...
            {
                QMenuWrapper* rslt = 
                    new QMenuWrapper(args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (nargs == 1) { do {
            ...
            {
                QMenuWrapper* rslt = 
                    new QMenuWrapper(args->arg_2_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (nargs == 2) { do {
            ...
            {
                QMenuWrapper* rslt = 
                    new QMenuWrapper(args->arg_2_1.getValue(), args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (explicitNew) {
            return util::argCountError(L, "QMenu", "new", nargs, "1,2,3");
        } else {
            return util::argCountError(L, "QMenu", nullptr, nargs, "0,1,2");
        }
    }
    catch (...) {
        return util::handleException(L);
...
extern "C" int lqtk_QMenu_constructor(lua_State* L, bool explicitNew)
{
    try {
        lqtk_QMenu_new_Args args(explicitNew);
        return BindingUtil::callMethodFromLua(L, lqtk_QMenu_new_doLua, &args);
    }    
    catch (...) {
        return util::handleException(L);
    }
...
extern "C" int lqtk_QMenu_new(lua_State* L)
{
    return lqtk_QMenu_constructor(L, true /*explicitNew*/);
}

/* ============================================================================================ */

ObjectUdata* QMenuBinding::pushObject(lua_State* L, QMenu* objPtr, OwnerType ownerType)
{
    QMenuWrapper* wrapper = dynamic_cast<QMenuWrapper*>(objPtr);
    ...
    {                                                                    // -> xxx
        ...
        udata = ObjectUdata::pushNew<QMenu>(L, hasUserValue);     // -> uval?, udata
...
static const Member members[] =
{
    ...
    { "addAction",             Member::NORMAL_FUNCTION,      (void*) lqtk_QMenu_addAction },
    { "addActions",            Member::NORMAL_FUNCTION,      (void*) lqtk_QWidget_addActions },
    { "addMenu",               Member::NORMAL_FUNCTION,      (void*) lqtk_QMenu_addMenu },
...
const ClassInfo QMenuBinding::classInfo = 
{
    "QMenu",
...
int QMenuBinding::pushBinding(lua_State* L)
{
