...
#include "QOpenGLWidgetWrapper.hpp"
...
/* -------------------------------------------------------------------------------------------- */
    ...
    QOpenGLWidgetWrapper::QOpenGLWidgetWrapper()
        : QOpenGLWidget(),
...
/* -------------------------------------------------------------------------------------------- */
    ...
    int QOpenGLWidgetWrapper::lqtk_destruct(lua_State* L) {
        QOpenGLWidget* objPtr = (QOpenGLWidget*)lua_touserdata(L, 1);
        StateGuard::clearWeakUserValue(L, objPtr);
        StateGuard::clearStrongUserValue(L, objPtr);
        return 0;
    }
    QOpenGLWidgetWrapper::~QOpenGLWidgetWrapper() {
        trace::printf("Deleting lqtk::QOpenGLWidgetWrapper: %p\n", this);
        if (lqtk_stateGuard) {
            lua_State* L = lqtk_stateGuard->getL();
            if (L) {
                QOpenGLWidget* objPtr = this;
                BindingUtil::callLuaDestructor(L, lqtk_destruct, objPtr, "QOpenGLWidget");
            }
            StateGuard::releaseRef(&lqtk_stateGuard, StateGuard::FOR_QT_OBJECT);
        }
    }

    void QOpenGLWidgetWrapper::lqtk_QWidget_closeEvent(
                   QCloseEvent* arg1) 
    {
    ...
    bool QOpenGLWidgetWrapper::lqtk_QWidget_event(
                   QEvent* arg1) 
    {
    ...
    void QOpenGLWidgetWrapper::lqtk_QWidget_mouseDoubleClickEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QOpenGLWidgetWrapper::lqtk_QWidget_mouseMoveEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QOpenGLWidgetWrapper::lqtk_QWidget_mousePressEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QOpenGLWidgetWrapper::lqtk_QWidget_mouseReleaseEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QOpenGLWidgetWrapper::lqtk_QWidget_paintEvent(
                   QPaintEvent* arg1) 
    {
    ...
    void QOpenGLWidgetWrapper::lqtk_QWidget_resizeEvent(
                   QResizeEvent* arg1) 
    {
...
/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::closeEvent(
                   QCloseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::closeEvent1_doLua, &args, "QOpenGLWidget", "closeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::closeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QOpenGLWidgetWrapper::event(
                   QEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QOpenGLWidget", "event");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QOpenGLWidget", "event", msg);
                }
            }
        }
        return QOpenGLWidget::event(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QOpenGLWidgetWrapper::hasHeightForWidth() const
    {
        lua_State* L = getL();
        if (L) {
            QWidgetWrapper::hasHeightForWidth1CallArgs args(
                    const_cast<QOpenGLWidgetWrapper*>(this)

            );
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::hasHeightForWidth1_doLua, &args, "QOpenGLWidget", "hasHeightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    const char* msg = "a boolean value";
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QOpenGLWidget", "hasHeightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    int QOpenGLWidgetWrapper::heightForWidth(
                   int arg2) const 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::heightForWidth1_doLua, &args, "QOpenGLWidget", "heightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QOpenGLWidget", "heightForWidth", msg);
                }
            }
        }
        return QOpenGLWidget::heightForWidth(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    QVariant QOpenGLWidgetWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QOpenGLWidget", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QOpenGLWidget", "inputMethodQuery", msg);
                }
            }
        }
        return QOpenGLWidget::inputMethodQuery(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::mouseDoubleClickEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseDoubleClickEvent1_doLua, &args, "QOpenGLWidget", "mouseDoubleClickEvent");
            }
            if (args.wasCalled) {
                return;
            }
...
/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::mouseMoveEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseMoveEvent1_doLua, &args, "QOpenGLWidget", "mouseMoveEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::mouseMoveEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::mousePressEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mousePressEvent1_doLua, &args, "QOpenGLWidget", "mousePressEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::mousePressEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::mouseReleaseEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseReleaseEvent1_doLua, &args, "QOpenGLWidget", "mouseReleaseEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::mouseReleaseEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::paintEvent(
                   QPaintEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::paintEvent1_doLua, &args, "QOpenGLWidget", "paintEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::paintEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::resizeEvent(
                   QResizeEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::resizeEvent1_doLua, &args, "QOpenGLWidget", "resizeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::resizeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QOpenGLWidgetWrapper::setVisible(
                   bool arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QOpenGLWidget", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QOpenGLWidget::setVisible(
                    arg2); 
    }
...
static void* castFunction(const ClassInfo* targetClassInfo, void* objectPtr)
{
    if (objectPtr)
    {
        QOpenGLWidgetBinding::QType* ptr = static_cast<QOpenGLWidgetBinding::QType*>(objectPtr);
        if (targetClassInfo == &QOpenGLWidgetBinding::classInfo) {
            return ptr;
        }
...
{
    if (objectPtr) {
        QOpenGLWidget* ptr = (QOpenGLWidget*) objectPtr;
        delete ptr;
    }
}
...
{
    if (objectPtr) {
        QOpenGLWidget* obj = (QOpenGLWidget*) objectPtr;
        
        QOpenGLWidgetWrapper* wrapper = dynamic_cast<QOpenGLWidgetWrapper*>(obj);
        if (wrapper) {
...
struct lqtk_QOpenGLWidget_new_Args
{
    FromLua<QWidget*> arg_1_1;
    FromLua<Qt::WindowFlags> arg_2_1;
    ToLua<QOpenGLWidget*> rslt_1;
};

extern "C" int lqtk_QOpenGLWidget_constructor(lua_State* L, bool explicitNew)
{
    lqtk_QOpenGLWidget_new_Args  argValues;
    lqtk_QOpenGLWidget_new_Args* args = &argValues;
    try {
        int argOffs = 0;
        int nargs = lua_gettop(L) - 1;
        ObjectUdata* udata = ObjectUdata::checkArg(L, 1, ObjectUdata::INITIAL);

        if (udata->classInfo != &QOpenGLWidgetBinding::classInfo)
        {
            return util::argError(L, 1, "initial object of type lqtk.Object<QOpenGLWidget> expected");
        }
        ...
        if (nargs == 0) { do {
            {
                QOpenGLWidgetWrapper* rslt = 
                    new QOpenGLWidgetWrapper();
                if (!rslt) {
        ...
        if (nargs == 1) { do {
          if (!lua_isnil(L, argOffs+1)) {
            ...
            {
                QOpenGLWidgetWrapper* rslt = 
                    new QOpenGLWidgetWrapper(args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (nargs == 2) { do {
            ...
            {
                QOpenGLWidgetWrapper* rslt = 
                    new QOpenGLWidgetWrapper(args->arg_1_1.getValue(), args->arg_2_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (explicitNew) {
            return util::argCountError(L, "QOpenGLWidget", "new", nargs, "1,2,3");
        } else {
            return util::argCountError(L, "QOpenGLWidget", nullptr, nargs, "0,1,2");
        }
    }
    catch (...) {
...
extern "C" int lqtk_QOpenGLWidget_new(lua_State* L)
{
    return lqtk_QOpenGLWidget_constructor(L, true /*explicitNew*/);
}

/* ============================================================================================ */

ObjectUdata* QOpenGLWidgetBinding::pushObject(lua_State* L, QOpenGLWidget* objPtr, OwnerType ownerType)
{
    QOpenGLWidgetWrapper* wrapper = dynamic_cast<QOpenGLWidgetWrapper*>(objPtr);
    ...
    {                                                                    // -> xxx
        ...
        udata = ObjectUdata::pushNew<QOpenGLWidget>(L, hasUserValue);     // -> uval?, udata
...
{
    { "LeftBuffer",            Member::INTEGER,              (void*) QOpenGLWidget::LeftBuffer },
    { "NoPartialUpdate",       Member::INTEGER,              (void*) QOpenGLWidget::NoPartialUpdate },
    { "PartialUpdate",         Member::INTEGER,              (void*) QOpenGLWidget::PartialUpdate },
    { "RightBuffer",           Member::INTEGER,              (void*) QOpenGLWidget::RightBuffer },
...
const ClassInfo QOpenGLWidgetBinding::classInfo = 
{
    "QOpenGLWidget",
    ...
    true,  // isQObject
    false, // needsGuard
    lqtk_QOpenGLWidget_constructor,
    lqtk_QOpenGLWidget_new,
    castFunction,
    deleteFunction,
...
int QOpenGLWidgetBinding::pushBinding(lua_State* L)
{
