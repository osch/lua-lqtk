...
/* -------------------------------------------------------------------------------------------- */
    ...
    int QTabWidgetWrapper::lqtk_destruct(lua_State* L) {
        QTabWidget* objPtr = (QTabWidget*)lua_touserdata(L, 1);
        StateGuard::clearWeakUserValue(L, objPtr);
        StateGuard::clearStrongUserValue(L, objPtr);
        return 0;
    }
    QTabWidgetWrapper::~QTabWidgetWrapper() {
        trace::printf("Deleting lqtk::QTabWidgetWrapper: %p\n", this);
        if (lqtk_stateGuard) {
            lua_State* L = lqtk_stateGuard->getL();
            if (L) {
                QTabWidget* objPtr = this;
                BindingUtil::callLuaDestructor(L, lqtk_destruct, objPtr, "QTabWidget");
            }
            StateGuard::releaseRef(&lqtk_stateGuard, StateGuard::FOR_QT_OBJECT);
        }
    }

    void QTabWidgetWrapper::lqtk_QWidget_closeEvent(
                   QCloseEvent* arg1) 
    {
    ...
    bool QTabWidgetWrapper::lqtk_QWidget_event(
                   QEvent* arg1) 
    {
    ...
    void QTabWidgetWrapper::lqtk_QWidget_mouseDoubleClickEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QTabWidgetWrapper::lqtk_QWidget_mouseMoveEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QTabWidgetWrapper::lqtk_QWidget_mousePressEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QTabWidgetWrapper::lqtk_QWidget_mouseReleaseEvent(
                   QMouseEvent* arg1) 
    {
    ...
    void QTabWidgetWrapper::lqtk_QWidget_paintEvent(
                   QPaintEvent* arg1) 
    {
    ...
    void QTabWidgetWrapper::lqtk_QWidget_resizeEvent(
                   QResizeEvent* arg1) 
    {
...
/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::closeEvent(
                   QCloseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::closeEvent1_doLua, &args, "QTabWidget", "closeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::closeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QTabWidgetWrapper::event(
                   QEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QObjectWrapper::event1_doLua, &args, "QTabWidget", "event");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QTabWidget", "event", msg);
                }
            }
        }
        return QTabWidget::event(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    bool QTabWidgetWrapper::hasHeightForWidth() const
    {
        lua_State* L = getL();
        if (L) {
            QWidgetWrapper::hasHeightForWidth1CallArgs args(
                    const_cast<QTabWidgetWrapper*>(this)

            );
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::hasHeightForWidth1_doLua, &args, "QTabWidget", "hasHeightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    const char* msg = "a boolean value";
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QTabWidget", "hasHeightForWidth", msg);
                }
            }
        }
...
/* -------------------------------------------------------------------------------------------- */
    int QTabWidgetWrapper::heightForWidth(
                   int arg2) const 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::heightForWidth1_doLua, &args, "QTabWidget", "heightForWidth");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QTabWidget", "heightForWidth", msg);
                }
            }
        }
        return QTabWidget::heightForWidth(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    QVariant QTabWidgetWrapper::inputMethodQuery(
                   Qt::InputMethodQuery arg2) const 
    {
        ...
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::inputMethodQuery1_doLua, &args, "QTabWidget", "inputMethodQuery");
            }
            if (args.wasCalled) {
                if (args.hasValidResult) {
                    return args.rslt;
                    ...
                    BindingUtil::throwMethodImplRsltError(L, args.arg1, "QTabWidget", "inputMethodQuery", msg);
                }
            }
        }
        return QTabWidget::inputMethodQuery(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::mouseDoubleClickEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseDoubleClickEvent1_doLua, &args, "QTabWidget", "mouseDoubleClickEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::mouseDoubleClickEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::mouseMoveEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseMoveEvent1_doLua, &args, "QTabWidget", "mouseMoveEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::mouseMoveEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::mousePressEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mousePressEvent1_doLua, &args, "QTabWidget", "mousePressEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::mousePressEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::mouseReleaseEvent(
                   QMouseEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::mouseReleaseEvent1_doLua, &args, "QTabWidget", "mouseReleaseEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::mouseReleaseEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::paintEvent(
                   QPaintEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::paintEvent1_doLua, &args, "QTabWidget", "paintEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::paintEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::resizeEvent(
                   QResizeEvent* arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::resizeEvent1_doLua, &args, "QTabWidget", "resizeEvent");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::resizeEvent(
                    arg2); 
    }

/* -------------------------------------------------------------------------------------------- */
    void QTabWidgetWrapper::setVisible(
                   bool arg2) 
    {
        lua_State* L = getL();
        if (L) {
            ...
            {
                BindingUtil::callLuaMethodImpl(L, QWidgetWrapper::setVisible1_doLua, &args, "QTabWidget", "setVisible");
            }
            if (args.wasCalled) {
                return;
            }
        }
        return QTabWidget::setVisible(
                    arg2); 
    }
...
static void* castFunction(const ClassInfo* targetClassInfo, void* objectPtr)
{
    if (objectPtr)
    {
        QTabWidgetBinding::QType* ptr = static_cast<QTabWidgetBinding::QType*>(objectPtr);
        if (targetClassInfo == &QTabWidgetBinding::classInfo) {
            return ptr;
        }
...
{
    if (objectPtr) {
        QTabWidget* ptr = (QTabWidget*) objectPtr;
        delete ptr;
    }
}
...
{
    if (objectPtr) {
        QTabWidget* obj = (QTabWidget*) objectPtr;
        
        QTabWidgetWrapper* wrapper = dynamic_cast<QTabWidgetWrapper*>(obj);
        if (wrapper) {
...
struct lqtk_QTabWidget_new_Args
{
    FromLua<QWidget*> arg_1_1;
    ToLua<QTabWidget*> rslt_1;
};

extern "C" int lqtk_QTabWidget_constructor(lua_State* L, bool explicitNew)
{
    lqtk_QTabWidget_new_Args  argValues;
    lqtk_QTabWidget_new_Args* args = &argValues;
    try {
        int argOffs = 0;
        int nargs = lua_gettop(L) - 1;
        ObjectUdata* udata = ObjectUdata::checkArg(L, 1, ObjectUdata::INITIAL);

        if (udata->classInfo != &QTabWidgetBinding::classInfo)
        {
            return util::argError(L, 1, "initial object of type lqtk.Object<QTabWidget> expected");
        }
        ...
        if (nargs == 0) { do {
            {
                QTabWidgetWrapper* rslt = 
                    new QTabWidgetWrapper();
                if (!rslt) {
        ...
        if (nargs == 1) { do {
            ...
            {
                QTabWidgetWrapper* rslt = 
                    new QTabWidgetWrapper(args->arg_1_1.getValue());
                if (!rslt) {
                    return luaL_error(L, "memory error");
                }
                udata->setQObjectPtr(L, -1, rslt, IS_OWNER);
        ...
        if (explicitNew) {
            return util::argCountError(L, "QTabWidget", "new", nargs, "1,2");
        } else {
            return util::argCountError(L, "QTabWidget", nullptr, nargs, "0,1");
        }
    }
    catch (...) {
...
extern "C" int lqtk_QTabWidget_new(lua_State* L)
{
    return lqtk_QTabWidget_constructor(L, true /*explicitNew*/);
}

/* ============================================================================================ */

ObjectUdata* QTabWidgetBinding::pushObject(lua_State* L, QTabWidget* objPtr, OwnerType ownerType)
{
    QTabWidgetWrapper* wrapper = dynamic_cast<QTabWidgetWrapper*>(objPtr);
    ...
    {                                                                    // -> xxx
        ...
        udata = ObjectUdata::pushNew<QTabWidget>(L, hasUserValue);     // -> uval?, udata
...
const ClassInfo QTabWidgetBinding::classInfo = 
{
    "QTabWidget",
...
int QTabWidgetBinding::pushBinding(lua_State* L)
{
